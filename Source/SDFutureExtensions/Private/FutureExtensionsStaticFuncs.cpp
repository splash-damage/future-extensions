...
SD::TExpectedFuture<void> SD::WhenAll(TArray<SD::TExpectedFuture<void>>&& Futures)
{
	if (Futures.Num() == 0)
	{
	...
	{
		Future.Then([CounterRef = CounterRef, PromiseRef = PromiseRef](SD::TExpected<void> Result)
			{
